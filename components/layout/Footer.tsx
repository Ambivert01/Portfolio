  ...
  return (
    <footer className="border-t border-border">
      ...
      <div className="mx-auto max-w-content px-6 py-10">
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-fg-subtle">
          {legal.map((l) => (
          ...
          <div className="flex items-center gap-1">
            {socials.map((s) => (
              <a
                ...
                aria-label={s.label}
                title={s.label}
                className="focus-ring group relative flex h-8 w-8 items-center justify-center rounded-lg text-fg-subtle transition-colors duration-150 hover:bg-bg-elevated hover:text-fg"
              >
                {s.icon}
              </a>
            ))}
